...
$subject = ( isset($_POST['subject']) ) ? $_POST['subject'] : 'Квиз с сайта Мягкие Окна Краснодар';
...
if(isset($_POST['answers']) && isset($_POST['questions'])){
	...
	foreach ($answers as $key => $value) {
		...
		if(is_array($questions[$key]['answer']['vars'])){
			$result_string .= $questions[$key]['answer']['vars'][$answers[$key]];
		}else{
			$result_string .= $answers[$key];
		}
...
if(isset($_POST)){
	...
	$result_string .= $label.": " . htmlspecialchars($value, ENT_QUOTES) . "<br>\n";
}
}
